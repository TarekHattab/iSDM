...
#'@usage likCA(occData,envData, longlat=TRUE,nf=5,occNative=NULL,envNative=NULL)
...
#'likelihood<-likCA(occData=occData,envData=envData[[c(1,5,6)]],longlat=TRUE)
#'
#' # Display the results
...
likCA<-function(occData, envData, longlat=TRUE,nf=5,occNative=NULL,envNative=NULL){
